      ...
      <main className="min-h-screen bg-background px-4 py-10 sm:px-6">
        <div className="mx-auto max-w-3xl space-y-6">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">Your authenticator protection is active. Client information remains unavailable until the professional identity and organisation have also passed Waypoint's controlled verification process.</p>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              ...
              <div className="rounded-lg border bg-muted/20 p-4 leading-6 text-muted-foreground">Creating a professional account does not verify credentials or affiliation. Waypoint administrators must record a controlled verification decision before invitation or client-summary access is enabled.</div>
