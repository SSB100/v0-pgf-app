      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="border-b pb-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Link href="/admin/content-registry" className="inline-flex items-center gap-2 rounded-lg border bg-card px-4 py-2 text-sm font-medium shadow-sm hover:bg-muted/50">
              <BookOpenCheck className="size-4" /> Content & evidence register
            </Link>
          </div>
