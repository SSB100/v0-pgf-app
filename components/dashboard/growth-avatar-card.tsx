...
const avatarConfig = {
  ...
  waka_journey: {
    name: "Waka",
    getStage: (level: number) => {
      if (level === 0) return { stage: "Shaped", image: "/images/avatar-waka-01.png", color: "text-primary", description: "The starting stage" }
      if (level < 3) return { stage: "Bound", image: "/images/avatar-waka-02.png", color: "text-primary", description: "Early activity in Waypoint" }
      if (level < 5) return { stage: "Ready", image: "/images/avatar-waka-03.png", color: "text-primary", description: "More Waypoint activities completed" }
      if (level < 7) return { stage: "Prepared", image: "/images/avatar-waka-04.png", color: "text-primary", description: "Your engagement journey is taking shape" }
      if (level < 9) return { stage: "Launched", image: "/images/avatar-waka-05.png", color: "text-primary", description: "Continued engagement with Waypoint" }
      if (level < 11) return { stage: "Carrying", image: "/images/avatar-waka-06.png", color: "text-primary", description: "Ongoing activity across Waypoint" }
      if (level < 14) return { stage: "Steady", image: "/images/avatar-waka-07.png", color: "text-primary", description: "A growing record of engagement" }
      if (level < 17) return { stage: "Guided", image: "/images/avatar-waka-08.png", color: "text-primary", description: "Further engagement with Waypoint" }
      if (level < 20) return { stage: "Travelling", image: "/images/avatar-waka-09.png", color: "text-primary", description: "A later engagement stage" }
      return { stage: "Wayfound", image: "/images/avatar-waka-10.png", color: "text-primary", description: "The current final visual stage" }
    },
  },
}
